...
# Define callback to update the select-year dropdown based on the selected statistics
@app.callback(
...
def update_output_container(input_year, dropdown_options):
    if dropdown_options == 'Recession Period Statistics':
        ...
        # ...
        # Existing code for the "Recession Period Statistics" section
        # ...

        # Add the code for the four graphs
        if dropdown_options == 'Recession Period Statistics':
            # Filter the data for recession periods
            recession_data = data[data['Recession'] == 1]
